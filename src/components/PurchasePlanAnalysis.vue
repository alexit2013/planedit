        ...
        <div class="modal-content">
          ...
          <div v-if="list && showCGPH" class="modal-body">
              <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                      <label class="input"><input disabled :checked="list.data.PriceEqual==1" class="icheck" name="habit" type="radio" value="1"> 长账期优先</label>
                      <span data-toggle="tooltip" title class="fa fa-question-circle" data-placement="top" data-original-title="价格相同，优先选择账期更长的供应商"></span>
                      <br>
                      <label class="input"><input disabled :checked="list.data.PriceEqual==2" class="icheck" name="habit" type="radio" value="2"> 大采购量优先</label>
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                      <label class="input"><input disabled :checked="!list.data.IsMatchJxq" @click="changeIsMatchJxq($event)" type="checkbox" name="IsJxq"> 近效期不选</label> <span data-toggle="tooltip" title="" class="fa fa-question-circle" data-original-title="效期12个月：近效期5个月，效期12个月以上：近效期12个月"></span>
                      <br>
                      <label class="input"><input disabled :checked="!list.data.IsMatchNotStock" @click="changeIsMatchNotStock($event)" type="checkbox" name="IsNoStock"> 库存不足不选</label> <span data-toggle="tooltip" title="" class="fa fa-question-circle" data-original-title="不选库存不满采购量的供应商"></span>
                  </div>
              </div>
              ...
              <div id='setting' class="collapse" style="padding-top:10px;" >
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7" style="display:inline-block;">
                          <select disabled class="form-control" name="PreferredSupplier" id="">
